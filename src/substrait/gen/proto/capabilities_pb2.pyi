...
class Capabilities(google.protobuf.message.Message):
    ...
    class SimpleExtension(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["function_keys", b"function_keys", "type_keys", b"type_keys", "type_variation_keys", b"type_variation_keys", "uri", b"uri"]
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["advanced_extension_type_urls", b"advanced_extension_type_urls", "simple_extensions", b"simple_extensions", "substrait_versions", b"substrait_versions"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
