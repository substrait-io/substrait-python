...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_EXTENDEDEXPRESSION'].fields_by_name['extension_uris']._options = None
    _globals['_EXTENDEDEXPRESSION'].fields_by_name['extension_uris']._serialized_options = b'\x18\x01'
