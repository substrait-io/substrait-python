...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _EXTENDEDEXPRESSION.fields_by_name['extension_uris']._options = None
    _EXTENDEDEXPRESSION.fields_by_name['extension_uris']._serialized_options = b'\x18\x01'
    ...
    _EXTENDEDEXPRESSION._serialized_end = 862