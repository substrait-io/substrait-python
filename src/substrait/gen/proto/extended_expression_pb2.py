...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 5, '', 'proto/extended_expression.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_EXTENDEDEXPRESSION']._serialized_end = 781