...
class ExpressionReference(google.protobuf.message.Message):
    ...
    @property
    def expression(self) -> proto.algebra_pb2.Expression: ...
    @property
    def measure(self) -> proto.algebra_pb2.AggregateFunction: ...
    @property
    ...
    def __init__(
        self,
        *,
        expression: proto.algebra_pb2.Expression | None = ...,
        measure: proto.algebra_pb2.AggregateFunction | None = ...,
...
class ExtendedExpression(google.protobuf.message.Message):
    ...
    @property
    def version(self) -> proto.plan_pb2.Version:
    ...
    def __init__(
        self,
        *,
        version: proto.plan_pb2.Version | None = ...,
