...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_SIMPLEEXTENSIONURI']._options = None
    _globals['_SIMPLEEXTENSIONURI']._serialized_options = b'\x18\x01'
    _globals['_SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE'].fields_by_name['extension_uri_reference']._options = None
    _globals['_SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE'].fields_by_name['extension_uri_reference']._serialized_options = b'\x18\x01'
    _globals['_SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION'].fields_by_name['extension_uri_reference']._options = None
    ...
    _globals['_SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION'].fields_by_name['extension_uri_reference']._options = None
