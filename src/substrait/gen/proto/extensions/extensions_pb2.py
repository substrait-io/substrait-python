...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SIMPLEEXTENSIONURI._options = None
    _SIMPLEEXTENSIONURI._serialized_options = b'\x18\x01'
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE.fields_by_name['extension_uri_reference']._options = None
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE.fields_by_name['extension_uri_reference']._serialized_options = b'\x18\x01'
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION.fields_by_name['extension_uri_reference']._options = None
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION.fields_by_name['extension_uri_reference']._serialized_options = b'\x18\x01'
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION.fields_by_name['extension_uri_reference']._options = None
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION.fields_by_name['extension_uri_reference']._serialized_options = b'\x18\x01'
    _SIMPLEEXTENSIONURI._serialized_start = 82
    _SIMPLEEXTENSIONURI._serialized_end = 174
    _SIMPLEEXTENSIONURN._serialized_start = 176
    _SIMPLEEXTENSIONURN._serialized_end = 264
    _SIMPLEEXTENSIONDECLARATION._serialized_start = 267
    _SIMPLEEXTENSIONDECLARATION._serialized_end = 1255
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE._serialized_start = 641
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPE._serialized_end = 825
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION._serialized_start = 828
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONTYPEVARIATION._serialized_end = 1040
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION._serialized_start = 1043
    _SIMPLEEXTENSIONDECLARATION_EXTENSIONFUNCTION._serialized_end = 1239
    _ADVANCEDEXTENSION._serialized_start = 1258
    _ADVANCEDEXTENSION._serialized_end = 1391