...
class SimpleExtensionURI(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_uri_anchor", b"extension_uri_anchor", "uri", b"uri"]
...
class SimpleExtensionURN(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_urn_anchor", b"extension_urn_anchor", "urn", b"urn"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class SimpleExtensionDeclaration(google.protobuf.message.Message):
    ...
    class ExtensionType(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_uri_reference", b"extension_uri_reference", "extension_urn_reference", b"extension_urn_reference", "name", b"name", "type_anchor", b"type_anchor"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class ExtensionTypeVariation(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_uri_reference", b"extension_uri_reference", "extension_urn_reference", b"extension_urn_reference", "name", b"name", "type_variation_anchor", b"type_variation_anchor"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class ExtensionFunction(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_uri_reference", b"extension_uri_reference", "extension_urn_reference", b"extension_urn_reference", "function_anchor", b"function_anchor", "name", b"name"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_function", b"extension_function", "extension_type", b"extension_type", "extension_type_variation", b"extension_type_variation", "mapping_type", b"mapping_type"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["extension_function", b"extension_function", "extension_type", b"extension_type", "extension_type_variation", b"extension_type_variation", "mapping_type", b"mapping_type"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_mapping_type: typing_extensions.TypeAlias = typing.Literal["extension_type", "extension_type_variation", "extension_function"]
    _WhichOneofArgType_mapping_type: typing_extensions.TypeAlias = typing.Literal["mapping_type", b"mapping_type"]
    def WhichOneof(self, oneof_group: _WhichOneofArgType_mapping_type) -> _WhichOneofReturnType_mapping_type | None: ...
...
class AdvancedExtension(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["enhancement", b"enhancement"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["enhancement", b"enhancement", "optimization", b"optimization"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
