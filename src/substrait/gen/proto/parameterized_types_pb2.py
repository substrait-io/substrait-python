...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARAMETERIZEDTYPE.fields_by_name['time']._options = None
    _PARAMETERIZEDTYPE.fields_by_name['time']._serialized_options = b'\x18\x01'
    ...
    _PARAMETERIZEDTYPE._serialized_end = 5245
    _PARAMETERIZEDTYPE_TYPEPARAMETER._serialized_start = 2012
    _PARAMETERIZEDTYPE_TYPEPARAMETER._serialized_end = 2097
    _PARAMETERIZEDTYPE_INTEGERPARAMETER._serialized_start = 2100
    _PARAMETERIZEDTYPE_INTEGERPARAMETER._serialized_end = 2322
    _PARAMETERIZEDTYPE_NULLABLEINTEGER._serialized_start = 2324
    _PARAMETERIZEDTYPE_NULLABLEINTEGER._serialized_end = 2363
    _PARAMETERIZEDTYPE_PARAMETERIZEDFIXEDCHAR._serialized_start = 2366
    _PARAMETERIZEDTYPE_PARAMETERIZEDFIXEDCHAR._serialized_end = 2558
    _PARAMETERIZEDTYPE_PARAMETERIZEDVARCHAR._serialized_start = 2561
    _PARAMETERIZEDTYPE_PARAMETERIZEDVARCHAR._serialized_end = 2751
    _PARAMETERIZEDTYPE_PARAMETERIZEDFIXEDBINARY._serialized_start = 2754
    _PARAMETERIZEDTYPE_PARAMETERIZEDFIXEDBINARY._serialized_end = 2948
    _PARAMETERIZEDTYPE_PARAMETERIZEDDECIMAL._serialized_start = 2951
    _PARAMETERIZEDTYPE_PARAMETERIZEDDECIMAL._serialized_end = 3209
    _PARAMETERIZEDTYPE_PARAMETERIZEDINTERVALDAY._serialized_start = 3212
    _PARAMETERIZEDTYPE_PARAMETERIZEDINTERVALDAY._serialized_end = 3412
    _PARAMETERIZEDTYPE_PARAMETERIZEDINTERVALCOMPOUND._serialized_start = 3415
    _PARAMETERIZEDTYPE_PARAMETERIZEDINTERVALCOMPOUND._serialized_end = 3620
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIME._serialized_start = 3623
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIME._serialized_end = 3825
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIMESTAMP._serialized_start = 3828
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIMESTAMP._serialized_end = 4035
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIMESTAMPTZ._serialized_start = 4038
    _PARAMETERIZEDTYPE_PARAMETERIZEDPRECISIONTIMESTAMPTZ._serialized_end = 4247
    _PARAMETERIZEDTYPE_PARAMETERIZEDSTRUCT._serialized_start = 4250
    _PARAMETERIZEDTYPE_PARAMETERIZEDSTRUCT._serialized_end = 4423
    _PARAMETERIZEDTYPE_PARAMETERIZEDNAMEDSTRUCT._serialized_start = 4425
    _PARAMETERIZEDTYPE_PARAMETERIZEDNAMEDSTRUCT._serialized_end = 4543
    _PARAMETERIZEDTYPE_PARAMETERIZEDLIST._serialized_start = 4546
    _PARAMETERIZEDTYPE_PARAMETERIZEDLIST._serialized_end = 4715
    _PARAMETERIZEDTYPE_PARAMETERIZEDMAP._serialized_start = 4718
    _PARAMETERIZEDTYPE_PARAMETERIZEDMAP._serialized_end = 4932
    _PARAMETERIZEDTYPE_PARAMETERIZEDUSERDEFINED._serialized_start = 4935
    _PARAMETERIZEDTYPE_PARAMETERIZEDUSERDEFINED._serialized_end = 5100
    _PARAMETERIZEDTYPE_INTEGEROPTION._serialized_start = 5103
    _PARAMETERIZEDTYPE_INTEGEROPTION._serialized_end = 5237