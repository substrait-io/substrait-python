...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PLAN.fields_by_name['extension_uris']._options = None
    _PLAN.fields_by_name['extension_uris']._serialized_options = b'\x18\x01'
    _PLANREL._serialized_start = 101
    _PLANREL._serialized_end = 192
    _PLAN._serialized_start = 195
    _PLAN._serialized_end = 789
    _PLANVERSION._serialized_start = 791
    _PLANVERSION._serialized_end = 846
    _VERSION._serialized_start = 849
    _VERSION._serialized_end = 1018
    _DYNAMICPARAMETERBINDING._serialized_start = 1020
    _DYNAMICPARAMETERBINDING._serialized_end = 1137