...
class PlanRel(google.protobuf.message.Message):
    ...
    @property
    def rel(self) -> substrait.gen.proto.algebra_pb2.Rel:
        """Any relation (used for references and CTEs)"""

    @property
    def root(self) -> substrait.gen.proto.algebra_pb2.RelRoot:
        """The root of a relation tree"""

    def __init__(
        self,
        *,
        rel: substrait.gen.proto.algebra_pb2.Rel | None = ...,
        root: substrait.gen.proto.algebra_pb2.RelRoot | None = ...,
    ) -> None: ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["rel", b"rel", "rel_type", b"rel_type", "root", b"root"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["rel", b"rel", "rel_type", b"rel_type", "root", b"root"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_rel_type: typing_extensions.TypeAlias = typing.Literal["rel", "root"]
...
class Plan(google.protobuf.message.Message):
    ...
    @property
    def type_aliases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[substrait.gen.proto.type_pb2.TypeAlias]:
    ...
    def __init__(
        ...
        *,
        ...
        type_aliases: collections.abc.Iterable[substrait.gen.proto.type_pb2.TypeAlias] | None = ...,
    ) -> None: ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["advanced_extensions", b"advanced_extensions", "version", b"version"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["advanced_extensions", b"advanced_extensions", "expected_type_urls", b"expected_type_urls", "extension_uris", b"extension_uris", "extension_urns", b"extension_urns", "extensions", b"extensions", "parameter_bindings", b"parameter_bindings", "relations", b"relations", "type_aliases", b"type_aliases", "version", b"version"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class Version(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["git_hash", b"git_hash", "major_number", b"major_number", "minor_number", b"minor_number", "patch_number", b"patch_number", "producer", b"producer"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class DynamicParameterBinding(google.protobuf.message.Message):
    ...
    @property
    def value(self) -> substrait.gen.proto.algebra_pb2.Expression.Literal:
    ...
    def __init__(
        ...
        *,
        parameter_anchor: builtins.int = ...,
        value: substrait.gen.proto.algebra_pb2.Expression.Literal | None = ...,
    ) -> None: ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["value", b"value"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["parameter_anchor", b"parameter_anchor", "value", b"value"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
