...
class Type(google.protobuf.message.Message):
    ...
    class Boolean(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "type_variation_reference", b"type_variation_reference"]
    ...
    class IntervalDay(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_precision", b"_precision", "precision", b"precision"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_precision", b"_precision", "nullability", b"nullability", "precision", b"precision", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType__precision: typing_extensions.TypeAlias = typing.Literal["precision"]
        _WhichOneofArgType__precision: typing_extensions.TypeAlias = typing.Literal["_precision", b"_precision"]
    ...
    class IntervalCompound(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "precision", b"precision", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class FixedChar(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["length", b"length", "nullability", b"nullability", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class Decimal(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "precision", b"precision", "scale", b"scale", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class Struct(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "type_variation_reference", b"type_variation_reference", "types", b"types"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class List(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "type", b"type", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class Map(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["key", b"key", "nullability", b"nullability", "type_variation_reference", b"type_variation_reference", "value", b"value"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class UserDefined(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "type_parameters", b"type_parameters", "type_reference", b"type_reference", "type_variation_reference", b"type_variation_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class Parameter(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["boolean", b"boolean", "data_type", b"data_type", "enum", b"enum", "integer", b"integer", "null", b"null", "parameter", b"parameter", "string", b"string"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["boolean", b"boolean", "data_type", b"data_type", "enum", b"enum", "integer", b"integer", "null", b"null", "parameter", b"parameter", "string", b"string"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
        _WhichOneofReturnType_parameter: typing_extensions.TypeAlias = typing.Literal["null", "data_type", "boolean", "integer", "enum", "string"]
        _WhichOneofArgType_parameter: typing_extensions.TypeAlias = typing.Literal["parameter", b"parameter"]
    ...
    class TypeAliasReference(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["nullability", b"nullability", "type_alias_reference", b"type_alias_reference"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["alias", b"alias", "binary", b"binary", "bool", b"bool", "date", b"date", "decimal", b"decimal", "fixed_binary", b"fixed_binary", "fixed_char", b"fixed_char", "fp32", b"fp32", "fp64", b"fp64", "i16", b"i16", "i32", b"i32", "i64", b"i64", "i8", b"i8", "interval_compound", b"interval_compound", "interval_day", b"interval_day", "interval_year", b"interval_year", "kind", b"kind", "list", b"list", "map", b"map", "precision_time", b"precision_time", "precision_timestamp", b"precision_timestamp", "precision_timestamp_tz", b"precision_timestamp_tz", "string", b"string", "struct", b"struct", "time", b"time", "timestamp", b"timestamp", "timestamp_tz", b"timestamp_tz", "user_defined", b"user_defined", "user_defined_type_reference", b"user_defined_type_reference", "uuid", b"uuid", "varchar", b"varchar"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["alias", b"alias", "binary", b"binary", "bool", b"bool", "date", b"date", "decimal", b"decimal", "fixed_binary", b"fixed_binary", "fixed_char", b"fixed_char", "fp32", b"fp32", "fp64", b"fp64", "i16", b"i16", "i32", b"i32", "i64", b"i64", "i8", b"i8", "interval_compound", b"interval_compound", "interval_day", b"interval_day", "interval_year", b"interval_year", "kind", b"kind", "list", b"list", "map", b"map", "precision_time", b"precision_time", "precision_timestamp", b"precision_timestamp", "precision_timestamp_tz", b"precision_timestamp_tz", "string", b"string", "struct", b"struct", "time", b"time", "timestamp", b"timestamp", "timestamp_tz", b"timestamp_tz", "user_defined", b"user_defined", "user_defined_type_reference", b"user_defined_type_reference", "uuid", b"uuid", "varchar", b"varchar"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_kind: typing_extensions.TypeAlias = typing.Literal["bool", "i8", "i16", "i32", "i64", "fp32", "fp64", "string", "binary", "timestamp", "date", "time", "interval_year", "interval_day", "interval_compound", "timestamp_tz", "uuid", "fixed_char", "varchar", "fixed_binary", "decimal", "precision_time", "precision_timestamp", "precision_timestamp_tz", "struct", "list", "map", "user_defined", "user_defined_type_reference", "alias"]
...
class TypeAlias(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["type", b"type"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["type", b"type", "type_alias_anchor", b"type_alias_anchor"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
