...
from substrait.builders.extended_expression import window_function, literal
            ...
            stee.ExpressionReference(
                expression=stalg.Expression(
                    window_function=stalg.Expression.WindowFunction(
                        ...
                        output_type=stt.Type(i64=stt.Type.I64(nullability=stt.Type.NULLABILITY_NULLABLE))
                    )
                ),
                output_names=["rn"],
            )
